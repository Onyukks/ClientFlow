...
-- CreateEnum
CREATE TYPE "ClientStatus" AS ENUM ('PROSPECT', 'ACTIVE', 'AT_RISK', 'INACTIVE');

-- CreateEnum
CREATE TYPE "DealStage" AS ENUM ('QUALIFIED', 'DISCOVERY', 'PROPOSAL', 'NEGOTIATION', 'WON', 'LOST');
...
-- CreateEnum
CREATE TYPE "ActivityType" AS ENUM ('CLIENT_CREATED', 'DEAL_UPDATED', 'TASK_CREATED', 'NOTE');
...
CREATE TABLE "Subscription" (
    "id" TEXT NOT NULL,
    "plan" "SubscriptionPlan" NOT NULL DEFAULT 'GROWTH',
